...
def plot(noticia):
    if (noticia.lower() == 'itub3'):
      df = pd.read_csv('https://raw.githubusercontent.com/wrodrigohs/techrere/main/itub3.csv')
    elif (noticia.lower() == 'itub4'):
      df = pd.read_csv('https://raw.githubusercontent.com/wrodrigohs/techrere/main/iutb4.csv')
    elif (noticia.lower() == 'petr3'):
      df = pd.read_csv('https://raw.githubusercontent.com/wrodrigohs/techrere/main/petr3.csv')
    else:
      df = pd.read_csv('https://raw.githubusercontent.com/wrodrigohs/techrere/main/petr4.csv')
  # Graph One
